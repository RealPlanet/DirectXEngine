...
{
	float4 tex_color = TextureColor.Sample(TextureColorSampler, (1.0 - input.texcoord) * 2);
...
//SPECULAR LIGHT CALC
	...
	float amount_specular_light = pow(max(0.0, dot(reflected_light, direction_to_camera)), shiningness);
